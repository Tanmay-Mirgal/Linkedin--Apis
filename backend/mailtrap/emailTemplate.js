...
export function WELCOME_EMAIL(name, profileUrl) {
	return `
  <!DOCTYPE html>
  <html lang="en">
  <head>
...
export const CONNECTION_ACCEPTED_EMAIL = (senderName, recipientName, profileUrl) => `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
export const COMMENT_NOTIFICATION_EMAIL= (recipientName, commenterName, postUrl, commentContent) => `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
